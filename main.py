...
# main.py 
from weather_dao import get_latest_weather_snapshot, insert_weather_snapshot, insert_lightning, insert_rainfall, insert_temperature, insert_humidity, insert_uvindex
...
def corn_job() -> dict:
    ...
    # Get last recor
    lastest_weather = get_latest_weather_snapshot() 
